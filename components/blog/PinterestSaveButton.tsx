...
export default function PinterestSaveButton({
  ...
  return (
    <a
      ...
      className="absolute top-3 left-3 inline-flex items-center gap-1.5 bg-[#E60023] text-white text-[13px] font-semibold pl-2.5 pr-3.5 py-1.5 rounded-full shadow-card hover:opacity-90 transition-opacity"
    >
