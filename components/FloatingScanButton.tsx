...
export default function FloatingScanButton({ propertyId }: { propertyId: string }) {
  ...
  return (
    <>
      ...
      >
        <span className="w-14 h-14 rounded-full bg-denim text-white shadow-lg shadow-black/20 flex items-center justify-center hover:opacity-90 transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-denim">
