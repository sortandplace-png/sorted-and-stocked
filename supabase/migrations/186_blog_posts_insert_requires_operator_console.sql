...
-- After this, all four write/read-draft policies on blog_posts are
-- TO authenticated and operator-console gated. The only PUBLIC policy left
-- is blog_posts_read_published, which is correct and is the one that keeps
-- the public blog serving.
