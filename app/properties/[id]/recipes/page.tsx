...
export default async function RecipesPage({
  ...
  const { data: recipes } = await supabase
    .from('recipes')
    .select('id, name, name_es, photo_url, kosher_type, course, tags, is_pesach, is_yom_tov, is_shabbos_only, approx_total_minutes, created_at, new_badge_until, recipe_property_links!inner(property_id)')
